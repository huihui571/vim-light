...
highlight Constant guifg=#ffa0a0 ctermfg=217           "string
highlight Identifier guifg=palegreen ctermfg=120       "func()
highlight Statement guifg=khaki ctermfg=186            "if for    
highlight DefinedName guifg=#ccaa66                    "define
highlight PreProc guifg=indianred ctermfg=167          "#ifdef
highlight Type guifg=darkkhaki ctermfg=143             "int char
highlight Special guifg=navajowhite ctermfg=223
highlight EnumerationValue guifg=#ccaaff               "enum
