...
hi underline guifg=#31fd53 guibg=NONE guisp=NONE gui=NONE ctermfg=84 ctermbg=NONE cterm=NONE
...
hi preproc guifg=#4e2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi taglistcomment guifg=#686868 guibg=#1a872c guisp=#1a872c gui=NONE ctermfg=242 ctermbg=28 cterm=NONE
hi taglisttitle guifg=#ff2bb1 guibg=#000000 guisp=#000000 gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi user4 guifg=#2bfff8 guibg=#4c2edf guisp=#4c2edf gui=NONE ctermfg=14 ctermbg=20 cterm=NONE
hi user5 guifg=#2bff4e guibg=#4c2edf guisp=#4c2edf gui=NONE ctermfg=10 ctermbg=20 cterm=NONE
hi user3 guifg=#2bff4e guibg=#4c2edf guisp=#4c2edf gui=NONE ctermfg=10 ctermbg=20 cterm=NONE
hi taglistfilename guifg=#ff2bdc guibg=#871a75 guisp=#871a75 gui=NONE ctermfg=13 ctermbg=89 cterm=NONE
hi taglisttagscope guifg=#686868 guibg=#1a872c guisp=#1a872c gui=NONE ctermfg=242 ctermbg=28 cterm=NONE
hi match guifg=#4e2bff guibg=#dcff2b guisp=#dcff2b gui=NONE ctermfg=13 ctermbg=190 cterm=NONE
hi subtitle guifg=#686868 guibg=NONE guisp=NONE gui=NONE ctermfg=242 ctermbg=NONE cterm=NONE
hi keyword guifg=#bbff33 guibg=NONE guisp=NONE gui=NONE ctermfg=191 ctermbg=NONE cterm=NONE
hi rubystringdelimiter guifg=#e3ffbb guibg=NONE guisp=NONE gui=NONE ctermfg=193 ctermbg=NONE cterm=NONE
hi type guifg=#da9d48 guibg=NONE guisp=NONE gui=NONE ctermfg=179 ctermbg=NONE cterm=NONE
...
hi vimmodeline guifg=#a2ffb2 guibg=NONE guisp=NONE gui=NONE ctermfg=157 ctermbg=NONE cterm=NONE
hi htmllink guifg=#4e2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi pmenum guifg=#a61a8f guibg=#1c021b guisp=#1c021b gui=NONE ctermfg=126 ctermbg=53 cterm=NONE
hi browsedirectory guifg=#5533ff guibg=#ff5c11 guisp=#ff5c11 gui=NONE ctermfg=13 ctermbg=202 cterm=NONE
hi char guifg=#ffccf7 guibg=#201a1f guisp=#201a1f gui=NONE ctermfg=225 ctermbg=234 cterm=NONE
hi browsesuffixes guifg=#ce21b1 guibg=#f528d3 guisp=#f528d3 gui=NONE ctermfg=163 ctermbg=13 cterm=NONE
...
hi rubypredefinedvariable guifg=#9c1383 guibg=NONE guisp=NONE gui=NONE ctermfg=126 ctermbg=NONE cterm=NONE
hi string guifg=#99ad6a guibg=NONE guisp=NONE gui=NONE ctermfg=107 ctermbg=NONE cterm=NONE
hi rubyexception guifg=#ff4e2b guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
hi rubyblockparameter guifg=#ff2bdc guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi repeat guifg=#b5412a guibg=NONE guisp=NONE gui=NONE ctermfg=124 ctermbg=NONE cterm=NONE
hi rubypredefinedidentifier guifg=#de5577 guibg=NONE guisp=NONE gui=NONE ctermfg=168 ctermbg=NONE cterm=NONE
hi rubyaccess guifg=#f4836f guibg=NONE guisp=NONE gui=NONE ctermfg=210 ctermbg=NONE cterm=NONE
hi rubysymbol guifg=#7697d6 guibg=NONE guisp=NONE gui=NONE ctermfg=110 ctermbg=NONE cterm=NONE
hi rubypredefinedconstant guifg=#ff9f76 guibg=NONE guisp=NONE gui=NONE ctermfg=216 ctermbg=NONE cterm=NONE
hi cursor guifg=#686868 guibg=#71ff89 guisp=#71ff89 gui=NONE ctermfg=242 ctermbg=84 cterm=NONE
hi mydiffsubname guifg=#2bdcff guibg=NONE guisp=NONE gui=NONE ctermfg=45 ctermbg=NONE cterm=NONE
hi mydiffcommline guifg=#ff2bdc guibg=#8b2d1a guisp=#8b2d1a gui=NONE ctermfg=13 ctermbg=88 cterm=NONE
hi mailqu guifg=#b2239a guibg=#000000 guisp=#000000 gui=NONE ctermfg=126 ctermbg=NONE cterm=NONE
hi mydiffnew guifg=#ff4e2b guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
hi spellerrors guifg=#686868 guibg=NONE guisp=NONE gui=NONE ctermfg=242 ctermbg=NONE cterm=NONE
hi mydiffremoved guifg=#ff4e2b guibg=NONE guisp=NONE gui=NONE ctermfg=196 ctermbg=NONE cterm=NONE
hi mydiffnormal guifg=#686868 guibg=#ff2bdc guisp=#ff2bdc gui=NONE ctermfg=242 ctermbg=13 cterm=NONE
hi charachter guifg=#dcff2b guibg=NONE guisp=NONE gui=NONE ctermfg=190 ctermbg=NONE cterm=NONE
hi done guifg=#ff2bdc guibg=#be26a5 guisp=#be26a5 gui=NONE ctermfg=13 ctermbg=5 cterm=NONE
hi perlpod guifg=#ffc05b guibg=NONE guisp=NONE gui=NONE ctermfg=215 ctermbg=NONE cterm=NONE
hi mailq guifg=#29bdda guibg=#000000 guisp=#000000 gui=NONE ctermfg=38 ctermbg=NONE cterm=NONE
hi kde guifg=#ff2bdc guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi browsefile guifg=#4024cf guibg=#1164ff guisp=#1164ff gui=NONE ctermfg=20 ctermbg=27 cterm=NONE
hi browsecurdirectory guifg=#da4729 guibg=#ff5c11 guisp=#ff5c11 gui=NONE ctermfg=160 ctermbg=202 cterm=NONE
hi spelllocale guifg=NONE guibg=#dcff2b guisp=#dcff2b gui=NONE ctermfg=NONE ctermbg=190 cterm=NONE
hi myspecialsymbols guifg=#ff2bdc guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi sql_statement guifg=#ff33dd guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi cics_statement guifg=#60e93d guibg=NONE guisp=NONE gui=NONE ctermfg=119 ctermbg=NONE cterm=NONE
hi namespace guifg=#b2239a guibg=NONE guisp=NONE gui=NONE ctermfg=126 ctermbg=NONE cterm=NONE
hi builtin guifg=#4b87ff guibg=NONE guisp=NONE gui=NONE ctermfg=69 ctermbg=NONE cterm=NONE
hi tablinefillsel guifg=#4e2bff guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi attribute guifg=#ff39de guibg=NONE guisp=NONE gui=NONE ctermfg=13 ctermbg=NONE cterm=NONE
hi statement guifg=#bbff33 guibg=NONE guisp=NONE gui=NONE ctermfg=191 ctermbg=NONE cterm=NONE
hi statementu guifg=#bbff33 guibg=NONE guisp=NONE gui=NONE ctermfg=191 ctermbg=NONE cterm=NONE
hi menu guifg=#ffef0a guibg=#35355a guisp=#35355a gui=NONE ctermfg=11 ctermbg=60 cterm=NONE
hi rubyconstant guifg=#ff9f76 guibg=NONE guisp=NONE gui=NONE ctermfg=216 ctermbg=NONE cterm=NONE
hi rubylocalvariableormethod guifg=#fffcff guibg=NONE guisp=NONE gui=NONE ctermfg=15 ctermbg=NONE cterm=NONE
hi xmltagname guifg=#fff4a9 guibg=NONE guisp=NONE gui=NONE ctermfg=229 ctermbg=NONE cterm=NONE
hi rubyclass guifg=#447799 guibg=NONE guisp=NONE gui=NONE ctermfg=67 ctermbg=NONE cterm=NONE
hi xmlendtag guifg=#fff4a9 guibg=NONE guisp=NONE gui=NONE ctermfg=229 ctermbg=NONE cterm=NONE
hi rubypseudovariable guifg=#ffeb99 guibg=NONE guisp=NONE gui=NONE ctermfg=222 ctermbg=NONE cterm=NONE
hi rubyinstancevariable guifg=#c6b6fe guibg=NONE guisp=NONE gui=NONE ctermfg=147 ctermbg=NONE cterm=NONE
hi xmltag guifg=#fff4a9 guibg=NONE guisp=NONE gui=NONE ctermfg=229 ctermbg=NONE cterm=NONE
hi rubyinterpolation guifg=#a2eeb3 guibg=NONE guisp=NONE gui=NONE ctermfg=157 ctermbg=NONE cterm=NONE
